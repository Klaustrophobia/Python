"""
Una empresa desea realizar un sistema donde el usuario ingrese productos, 
con el codigo, nombre, precio de venta, costo, cantidad en inventario, asi 
mismo podra realizar consultas sobre productos para lo cual ingresara el nombre 
del producto y el sistema le mostrara todos los datos de este producto, luego el 
usuario podra realizar entradas al inventario y salidas del inventario de cada 
producto, entonces cuando sea una entrada este valor se sumara a la cantidad en 
inventario y cuando sea una salida se restara la cantidad del inventario, el usuario 
podra realizar n cantidad de transacciones en el sistema 
"""
